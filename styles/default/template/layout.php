...
echo $UrlPath=='index'?'':' - '.$Config['SiteName']; ?></title>
	...
	<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>static/img/favicon.ico" />
...
?>
		...
		<div class="Copyright">
			<p>
			Powered By <a href="resume/index.html" target="_blank">Kendy Meshawby</a> V<?php echo $Config['Version']; ?> © 2019-2020
